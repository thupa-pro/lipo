          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-8">
                <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-violet-600 rounded-2xl flex items-center justify-center shadow-lg">
              ...
              <div className="relative">
                ...
                <div className="relative bg-white/90 dark:bg-white/10 backdrop-blur-xl border border-blue-200/50 dark:border-white/20 shadow-2xl rounded-3xl p-8">
                  <div className="text-center mb-6">
                    <h2 className="text-2xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
                      Sign in to Loconomy
                    </h2>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full h-12 bg-white/50 dark:bg-white/5 border border-slate-200 dark:border-white/20 rounded-2xl px-4 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">
                    ...
                    <Button className="w-full h-12 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white rounded-2xl font-semibold text-lg shadow-lg hover:shadow-blue-500/25 transition-all duration-300">
                      Sign In
                    </Button>
                  </div>
