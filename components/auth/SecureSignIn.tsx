            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-ai-500 hover:text-ai-700 dark:text-ai-400 dark:hover:text-ai-300 transition-colors focus-visible-ring rounded-sm"
                  disabled={isSubmitting}
                >
                  {showPassword ? (
